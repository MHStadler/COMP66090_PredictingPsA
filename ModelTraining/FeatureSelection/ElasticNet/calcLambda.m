function [ lambda ] = calcLambda( X, y, alpha, nLambda)
%calcLambda Calc lambda range for ElasticNet
%
%   [ lambda ] = calcLambda( X, y, alpha, nLambda)
%
%   Calc the lambda values for X, with labels y, and alpha. Returns nLambda
%   values on the log range - code taken from matlab lasso function

lambdaRatio = 0.0001;

[lambdaMax, ~] = computeLambdaMax(X, y, [], alpha, true);
